...
# %% auto 0
__all__ = ['find_var', 'read_var', 'update_var', 'BaseMaker', 'make_code_cell', 'make_code_cells', 'decor_id', 'retr_exports',
           'ModuleMaker', 'relative_import', 'update_import', 'basic_export_nb2']
...
@patch
def make(self:BaseMaker, cells, all_cells=None):
...
@patch
def write(self:ModuleMaker, cells, all_cells=None, lib_name=None, offset=0, autogenerate=True):
