...
class ModuleMaker:
    ...
    def write_contents(self, cells=None, offset=0, mode="w", autogenerate=False, endline=False):
    ...
    def _make_exists(self, cells):
        ...
        self.write_contents(cells, 0, "a", False, False)
...
def make_code_cell(code:str): 
    ...
    return AttrDict(source=code, cell_type="code", execution_count=None)
